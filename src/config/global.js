export default {
  global: {
    componenteFormativo:
      '<em><em>Merchandising</em></em>, demostración y presentación en el punto de ventas',
    descripcionCurso:
      'Cuando el consumidor observa una vitrina o una estantería, puede sentirse atraído por un producto exhibido y tener el impulso de comprarlo o leer determinada información, así dicha vitrina genera un vínculo entre cliente y espacio; ese es el impacto que el <em>merchandising</em> causa en el consumidor y es una estrategia ganadora para impulsar las ventas de los productos.',
